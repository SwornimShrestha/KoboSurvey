          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <div
                  onClick={handleClear}
                  className={` cursor-pointer group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-red-500 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
